                ...
                <Row>
                    ...
                    <div className="footer-socialmedia">
                        ...
                        <a target="blank" href="https://facebook.com">
                            <Image src={FacebookIcon} className="footer-socialmedia__icons" />
                        </a>
                        <a target="blank" href="https://twitter.com">
                            <Image src={TwitterIcon} className="footer-socialmedia__icons" />
                        </a>
                        <a target="blank" href="https://instagram.com">
                            <Image src={InstagramIcon} className="footer-socialmedia__icons" />
                        </a>
