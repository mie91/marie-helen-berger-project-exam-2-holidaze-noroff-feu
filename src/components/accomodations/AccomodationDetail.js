        ...
        <div className="accomodation-detail">
          <Row className="justify-content-md-center">
            ...
            <Col lg={6} md={12} sm={12}>
              <Image
                fluid
                className="accomodation-detail__image"
                src={detail.image}
              />
            </Col>
            <Col>
              <h4 className="accomodation-detail__header accomodation-detail__header--sub">
                Description
              </h4>
              <p className="accomodation-detail__description">
                {detail.description}
              </p>
              <h4 className="accomodation-detail__header accomodation-detail__header--sub">
                Details
              ...
              <Row className="justify-content-md-center">
                <Col lg={6} md={6} sm={6} xs={12}>
                  ...
                  <div className="accomodation-detail__details accomodation-detail__details--catering">
                    <p>
                      Self Catering:{" "}
                      <u> {detail.selfCatering ? "Yes" : "No"}</u>
                    </p>
                  </div>
          ...
          <Row>
            <Col className="col-md-12">
              <div className="basic-btn basic-btn--dark accomodation-detail__btn">
                <Link to={`/establishments/inquiry/${detail.id}`}>
                  Send Enquiry
                </Link>
              </div>
            </Col>
